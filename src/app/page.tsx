...
const Hero = () => {
  ...
  // Update mouse position for the grid spotlight effect
  useEffect(() => {
  ...
  return (
    <main className="w-full bg-black text-white selection:bg-purple-500/30">
      ...
      >
        ...
        {/* --- 1. THE "BETTER" TURBO GRID --- */}
        <div className="absolute inset-0 z-0 pointer-events-none">
            
            {/* Base Grid Layer (Static & Dim) */}
            <div 
                className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff0a_1px,transparent_1px),linear-gradient(to_bottom,#ffffff0a_1px,transparent_1px)] bg-[size:40px_40px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]"
            />

            {/* Mouse Spotlight Layer (Reveals the grid brighter) */}
            <div 
            ...
            {/* Vertical "Quantum Beams" (Shooting Stars) */}
            {/* We create multiple beams with different delays/positions for a random data-flow feel */}
...
// These are the "shooting stars" that travel down the grid lines
